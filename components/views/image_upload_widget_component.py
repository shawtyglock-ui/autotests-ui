...
class ImageUploadWidgetComponent(BaseComponent):
    def __init__(self, page: Page, identifier: str):
        ...
        self.image_upload_info_icon = page.get_by_test_id('create-course-preview-image-upload-widget-info-icon')
        ...
        self.upload_input = page.get_by_test_id('create-course-preview-image-upload-widget-input')
